  ...
  <q-page class="page pre-formatted">
    ...
    >
      ...
      <q-icon
        ...
        style="cursor: pointer;"
      ></q-icon>
      <div id="imageSourcesButtonContainer" style="position: absolute; right: 0px; text-align: right; padding-right: 20px; cursor: pointer;"><p @click="showImageSources()">View image sources</p></div></td>
      </div>
    </div>
    ...
    showImageSources () {
      this.$q.dialog({
        ...
        message:
          ...
          '<li><strong>Logos</strong>: <a target="_blank" rel="noopener noreferrer" href="https://commons.wikimedia.org/wiki/File:Debian-OpenLogo.svg" style="color: white;">Debian</a> <a target="_blank" rel="noopener noreferrer" href="https://commons.wikimedia.org/wiki/File:Neon-logo.svg" style="color: white;">KDE neon</a> <a target="_blank" rel="noopener noreferrer" href="https://commons.wikimedia.org/wiki/File:Kubuntu_logo.svg" style="color: white;">Kubuntu</a> <a target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/File:Linux_Mint_Official_Logo.svg" style="color: white;">Linux Mint</a> <a target="_blank" rel="noopener noreferrer" href="https://commons.wikimedia.org/wiki/File:Ubuntu_logo.svg" style="color: white;">Ubuntu</a> <a target="_blank" rel="noopener noreferrer" href="https://commons.wikimedia.org/wiki/File:KDE_logo.svg" style="color: white;">KDE</a> <a target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/File:Gnomelogo.svg" style="color: white;">GNOME</a> <a target="_blank" rel="noopener noreferrer" href="https://commons.wikimedia.org/wiki/File:Xfce_logo.svg" style="color: white;">XFCE</a> <a target="_blank" rel="noopener noreferrer" href="https://commons.wikimedia.org/wiki/File:Cinnamon-logo.svg" style="color: white;">Cinnamon</a></li>' +
